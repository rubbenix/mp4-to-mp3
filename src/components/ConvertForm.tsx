...
export default function ConvertForm() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const qualitySelect = (e.target as HTMLFormElement).elements.namedItem('quality') as HTMLSelectElement;
    ...
    return (
        ...
        >
            <div
                ...
                className={`w-full border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-colors ${dragActive ? 'border-purple-600 bg-purple-50' : 'border-gray-300 hover:border-purple-500'
                    }`}
            >
                {file ? (
                    <div>
            ...
            <div className="mt-4 w-full">
                ...
                <select
                    id="quality"
                    name="quality"
                    className="mt-1 block w-fullr ounded-md border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 text-gray-700"
                    defaultValue="medium"
                >
